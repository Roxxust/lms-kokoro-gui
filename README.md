...
tiny is fastest but can be off, small takes a little bit but is more accurate..<br/>
use ctrl + b to toggle STT anywhere but in-app<br/>

#### voice sources/alt onnx downloads:<br/>
